...
@RestController
@RequestMapping("/api/nomination-kafka")
public class NominationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NominationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NominationKafkaResource(KafkaProperties kafkaProperties) {
